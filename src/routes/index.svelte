<article class='min-vh-100'>
  ...
  <section id='sobre' class='d-flex flex-column justify-content-center align-items-center min-vh-100'>
    <div class='container'>
  ...
  <section id='o-evento' class='d-flex flex-column justify-content-center align-items-center min-vh-100'>
    <div class='container'>
      <h1>O Evento</h1>
